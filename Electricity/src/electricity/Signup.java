...
public class Signup extends JFrame implements ActionListener
{
    ...
    Signup(){
        ...
        p1.setForeground(new Color(34,139,24));
        p1.setBorder(new TitledBorder(new LineBorder(new Color(172,216,230),2), "Created-Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(173,216,230)));
        add(p1);
        ...
        //Image i2 = i1.getImage().getSacledInstance(250,250,Image.SCALE_DEFAULT);
