...
//      First Column
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/icon.png"));
...
//        Calculator
        ut2.setFont(new Font("monospcaced",Font.PLAIN,12));
...
//        Exit
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        {
            new UpdateInforamtion(meter).setVisible(true);
        }
